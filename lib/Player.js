...
var _BlendedTimeline = _interopRequireDefault(require("./BlendedTimeline.js"));
...
function (_Observable) {
  ...
  function Player(timeline, _ref) {
    ...
    _this._slopeTimelineBuilder = new _SlopeTimelineBuilder.default();
  ...
  _createClass(Player, [{
    ...
    value: function transitionToTimeline(timeline, duration, easing) {
      var _this2 = this;

      var slopeTimeline = this._slopeTimelineBuilder.build(this._timeline, this._time, this._duration, duration, this._state);

      var blendedTimeline = new _BlendedTimeline.default(slopeTimeline, timeline, easing);
