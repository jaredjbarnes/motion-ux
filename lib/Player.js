...
var _SlopeAnimationBuilder = _interopRequireDefault(require("./SlopeAnimationBuilder.js"));

var _BlendedAnimation = _interopRequireDefault(require("./BlendedAnimation.js"));
...
function (_Observable) {
  ...
  function Player(animation, _ref) {
    var _this;
    ...
    _this._render = typeof render === "function" ? render : defaultRender;
    _this._slopeAnimationBuilder = new _SlopeAnimationBuilder.default();
  ...
  _createClass(Player, [{
    ...
    key: "transitionToTimeline",
    value: function transitionToTimeline(animation, duration, easing) {
      var _this2 = this;

      var slopeAnimation = this._slopeAnimationBuilder.build(this._animation, this._time, this._duration, duration, this._state);

      var blendedAnimation = new _BlendedAnimation.default(slopeAnimation, animation, easing);
      ...
      var observer = this.observeTime(1, function () {
        _this2._animation = animation;
        observer.dispose();
        transitionObserver.dispose();
      });
      var transitionObserver = this.observe("TRANSITION", function () {
        observer.dispose();
        transitionObserver.dispose();
      });
      return this;
