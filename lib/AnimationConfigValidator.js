...
var AnimationConfigValidator =
/*#__PURE__*/
function () {
  function AnimationConfigValidator() {
    _classCallCheck(this, AnimationConfigValidator);

    this.config = null;
  }

  _createClass(AnimationConfigValidator, [{
    key: "setConfig",
    ...
    value: function validateNodes() {
      ...
      if (!this.areGraphStructuresEqual()) {
        throw new Error("Invalid Animation: The value types that are being animated do not match. From: ".concat(JSON.stringify(config.from.value), ", To:").concat(JSON.stringify(config.to.value), ", Controls: ").concat(JSON.stringify(config.controls.map(function (v) {
          return v.value;
        }))));
      }
    }
  ...
  return AnimationConfigValidator;
}();

exports.default = AnimationConfigValidator;
//# sourceMappingURL=AnimationConfigValidator.js.map