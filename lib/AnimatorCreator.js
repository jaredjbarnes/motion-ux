...
var _CssValueNodeAnimator = _interopRequireDefault(require("./animators/CssValueNodeAnimator.js"));
...
function () {
  ...
  _createClass(AnimatorCreator, [{
    ...
    key: "_convertAnimationsToAnimations",
    value: function _convertAnimationsToAnimations() {
      this.timelineOptions = this.animationOptions.map(function (animationOption) {
        return new _Animation.default(animationOption);
      });
    }
  }, {
    key: "_sortAnimations",
    value: function _sortAnimations() {
