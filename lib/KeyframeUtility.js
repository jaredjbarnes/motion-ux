...
/*#__PURE__*/
function () {
  function KeyframeUtility() {
    _classCallCheck(this, KeyframeUtility);

    this.config = null;
  }

  _createClass(KeyframeUtility, [{
    key: "_setConfig",
    ...
    key: "_normalizeValue",
    value: function _normalizeValue() {
    ...
    value: function _normalizeControls() {
      ...
      if (validator.hasValidControlsAsStrings()) {
        this.result.controls = this.config.controls.map(function (control) {
          return new _ParsedValue.default(control);
        });
      } else {
  ...
  return KeyframeUtility;
}();

exports.default = KeyframeUtility;
//# sourceMappingURL=KeyframeUtility.js.map