...
function () {
  function BlendedEasing(options) {
    ...
    this.transitionSpan = typeof options.transitionSpan === "number" ? options.transitionSpan : 0.25;
  ...
  _createClass(BlendedEasing, [{
    ...
    value: function valueAt(percentage) {
      var adjustedPercentage = this.easing.valueAt(percentage / this.transitionSpan);
