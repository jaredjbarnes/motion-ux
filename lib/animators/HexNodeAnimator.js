...
function () {
  ...
  _createClass(HexNodeAnimator, [{
    ...
    value: function render(progress) {
      var red = Math.round(this.redAnimator.render(progress));
      var green = Math.round(this.greenAnimator.render(progress));
      var blue = Math.round(this.blueAnimator.render(progress));
