...
var animators = [_ColorAnimator.default, _FunctionAnimator.default, _NumberAnimator.default, _UnitAnimator.default, _UnitArrayAnimator.default];

var _default = function _default(options) {
  return animators.find(function (Animator) {
    return Animator.isMatch(options);
  });
};

exports.default = _default;
//# sourceMappingURL=getAnimator.js.map