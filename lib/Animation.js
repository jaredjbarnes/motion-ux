  ...
  _createClass(Animation, [{
    ...
    value: function validateNodes() {
      ...
      if (!allStructuresAreEqual) {
        throw new Error("Invalid Animation: The value types that are being animated do not match. From: ".concat(JSON.stringify(this.from), ", To:").concat(JSON.stringify(options.to), ", Controls: ").concat(JSON.stringify(this.controls)));
      }
    }
  }]);
