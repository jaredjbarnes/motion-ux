...
function () {
  ...
  _createClass(Animation, [{
    ...
    value: function createNodeTrees() {
      ...
      this.fromNode = treeNormalizer.normalize(_cssValue.default.parse(new _clarityPatternParser.Cursor(this.from))); // This needs to be the to node so that all non number nodes
