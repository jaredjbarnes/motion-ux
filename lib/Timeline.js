...
function () {
  ...
  _createClass(Timeline, [{
    ...
    value: function render() {
      ...
      Array.from(values.keys()).forEach(function (target) {
        var changes = values.get(target);
    ...
    value: function getValuesAt(progress) {
      ...
      this.animators.filter(function (animator) {
        var obj = results.get(animator.options.target);
        ...
        var changes = results.get(animator.options.target);
        changes[animator.options.name] = animator.render(progress, _this.duration);
      });
      this.animators.filter(function (animator) {
