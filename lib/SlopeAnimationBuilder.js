...
var SlopeAnimationBuilder =
/*#__PURE__*/
function () {
  function SlopeAnimationBuilder() {
    _classCallCheck(this, SlopeAnimationBuilder);
  ...
  _createClass(SlopeAnimationBuilder, [{
    key: "cloneValues",
    ...
    key: "build",
    value: function build(animation, offset, duration, newDuration, direction) {
    ...
    value: function createSlopeTimeline() {
      ...
      var keyframes = Object.keys(this.nowValues).map(function (name) {
      ...
      this.slopeAnimation = new _Animation.default(keyframes);
    }
  }]);

  return SlopeAnimationBuilder;
}();

exports.default = SlopeAnimationBuilder;
//# sourceMappingURL=SlopeAnimationBuilder.js.map