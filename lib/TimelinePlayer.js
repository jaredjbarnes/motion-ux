...
function (_Observable) {
  _inherits(TimelinePlayer, _Observable);

  function TimelinePlayer(timeline, _ref) {
    var _this;
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TimelinePlayer).call(this));
  ...
  _createClass(TimelinePlayer, [{
    ...
    value: function dispose() {
      ...
      _get(_getPrototypeOf(TimelinePlayer.prototype), "dispose", this).call(this);
    }
  }, {
    key: "time",
    get: function get() {
