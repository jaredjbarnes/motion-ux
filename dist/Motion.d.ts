...
export default class Motion<T extends {}> {
    ...
    segueTo(to: IAnimation<T>, duration?: number, easing?: EasingFunction, onComplete?: typeof defaultOnComplete): this;
    segueToLoop(to: IAnimation<T>, duration: number | undefined, easing: EasingFunction, onComplete?: typeof defaultOnComplete): this;
