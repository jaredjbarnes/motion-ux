...
class Transition {
    ...
    isActivelyMoving() {
        return this.player.state !== PlayerState.STOPPED || this.isLoop(this._currentState);
    }
    isLoop(state) {
...
export { Animation, Animator, BezierCurve, CssKeyframe, Keyframe, Player, PlayerState, RepeatDirection, StatefulMotion, Transition, createDynamicEasing, easings };
